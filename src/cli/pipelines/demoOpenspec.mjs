...
import { createNewTask, nowISO } from "../../core/task.mjs";
import { runPlanningWithInputs } from "../../core/planning.mjs";
import { runCodegenCore } from "../../core/codegen.mjs";

export async function runDemoOpenspecPipeline({ cwd, aiDir, cfg }) {
    ...
    try {
        ...
        error = e;
        console.log(
            chalk.red(`[pipeline] failed at stage ${currentStage}:`),
            e.message || e
        );
        process.exitCode = 1;
    } finally {
